...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/unitab_BACKUP_31264.dbg:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/unitab_BACKUP_31264.dbg \
    $(LOCAL_PATH)/configs/wifi/unitab_BASE_31264.dbg:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/unitab_BASE_31264.dbg \
    $(LOCAL_PATH)/configs/wifi/unitab_LOCAL_31264.dbg:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/unitab_LOCAL_31264.dbg \
    $(LOCAL_PATH)/configs/wifi/unitab_REMOTE_31264.dbg:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/unitab_REMOTE_31264.dbg \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/a50dd/a50dd-vendor.mk)
